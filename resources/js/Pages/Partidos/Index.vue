<template>
    <app-layout title="Partidos - Listar">
        ...
        <div class="relative mt-6 mx-auto">
            ...
            <button type="button" @click="openModal()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Abrir filtros</button>
            ...
            <div v-for="partido in partidosFiltrados.data" :key="partido.id">
                <div class="my-3 bg-white shadow-md rounded-md p-4">
                    ...
                    <h1 class="text-2xl font-black mt-3 mb-6 md:pb-7">
                        <Link :href="route('partidos.show', partido.slug)" class="hover:underline">
                            {{ partido.nombre }}
                        </Link>
                    </h1>
                    <div class="md:relative text-base">
                        <div class="flex flex-wrap space-x-2 md:absolute md:inset-x-0 md:bottom-0">
                            <div class="text-blue-900 text-black rounded-full bg-blue-50 border border-blue-200 p-2 my-2 md:my-0">
                        ...
                        <div class="flex justify-start md:justify-end md:absolute md:inset-x-0 md:bottom-0 mt-3 md:mt-0">
                            <button type="button" class="px-2.5 py-2.5 rounded-full shadow-md bg-blue-600 text-white hover:bg-blue-800 hover:shadow-lg">
                                Quiero jugar
                            </button>
                        </div>
