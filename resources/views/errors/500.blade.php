	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
				...
				<h5 class="text-black font-semibold mb-6">Tenemos problemas en nuestro servidor. 
                    Actualice/recargue la página y si esto no lo resuelve vuelva a ingresar mas tarde.</h5>
